...
function getallform(response) {
    var _this = this;
    typeorm_1.createConnection().then(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var forms, resForms;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.manager.find(Formdata_1.Formdata)];
                case 1:
                    forms = _a.sent();
                    console.log(typeof (forms));
                    resForms = JSON.stringify(forms);
                    return [2 /*return*/, response.json(resForms)];
            }
        });
    }); });
}
