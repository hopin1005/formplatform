...
exports.successAddForm = void 0;
var Formdatarepo_1 = require("../EntityRepo/Formdatarepo");
...
function successAddForm(url, referer, userid) {
    ...
    function addUserWrittenRecord() {
        return __awaiter(this, void 0, void 0, function () {
            var user, form, classUserWrittenForm;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        console.log(user);
                        return [4 /*yield*/, formRepo.findOne({
                                select: ["id"],
                                where: {
                                    link: url
                                }
                    ...
                    case 2:
                        ...
                        if (user && form != undefined) {
                            classUserWrittenForm = new User_written_Formdata_1.UserWrittenFormdata();
...
exports.successAddForm = successAddForm;
