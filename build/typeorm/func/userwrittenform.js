...
exports.getUserWrittenForm = void 0;
...
function getUserWrittenForm(userid) {
    ...
    function getWrittenArray() {
        return __awaiter(this, void 0, void 0, function () {
            var user, _a, userWrittenForm, userWrittenCount, writtenArray, res;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        writtenArray = [];
                        userWrittenForm.forEach(function (element) {
                            console.log(element.formdataId);
                            writtenArray.push(element.formdataId);
                        });
                        res = { "formWritten": writtenArray };
                        return [2 /*return*/, res];
                }
            });
        });
...
exports.getUserWrittenForm = getUserWrittenForm;
