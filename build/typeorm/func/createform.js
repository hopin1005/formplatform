...
var cancreateform_1 = require("../func/cancreateform");
// {
//         "name": "formname5",
//               "info": "forminfo5",
...
function createForm(form, userid) {
    ...
    function create() {
        return __awaiter(this, void 0, void 0, function () {
            var cancreate, formRepo, formcheck, repo, time;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cancreateform_1.cancreateform(userid)
                        //check if repeate url
                    ];
                    case 1:
                        cancreate = _a.sent();
                        formRepo = Formdatarepo_1.createFormRepo();
                    ...
                    case 2:
                        ...
                        if (cancreate.success == 'true' && formcheck == undefined) {
                            repo = Formdatarepo_1.createFormRepo();
                            time = getTime_1.getTime();
                            form.startTime = time;
                            repo.save(form);
